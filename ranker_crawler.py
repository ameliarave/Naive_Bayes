...
def main():
    target_url = ""
    if(sys.argv[1] == "famous"):
        target_url = "https://www.ranker.com/list/the-all-time-greatest-people-in-history/alan-smithee"
    else:
        target_url = "https://www.ranker.com/crowdranked-list/the-all-time-worst-people-in-history"

    people_dictionary = get_page_content(target_url)
